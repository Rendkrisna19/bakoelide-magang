...
<body class="bg-gray-100 py-10">
    <div class="max-w-3xl mx-auto bg-white p-8 rounded shadow">
        ...
        <form method="POST" action="<?php echo e(route('quiz.submit')); ?>" class="space-y-6">
            <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\bakoelide-magang-main\resources\views/small-business/small-business.blade.php ENDPATH**/ ?>