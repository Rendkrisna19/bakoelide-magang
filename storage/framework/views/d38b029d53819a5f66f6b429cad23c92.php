...
<body class="min-h-screen flex bg-[#ffcc80] overflow-hidden">    <div class="w-1/2 flex justify-center items-center p-10">
        <div class="w-full max-w-md bg-white bg-opacity-80 p-8 rounded-xl shadow-lg">
            ...
            <form method="POST" action="<?php echo e(route('login')); ?>">
                ...
                <div class="mb-4">
                    <div class="flex rounded-lg shadow-sm bg-[#ffe0cc]">
                        <span class="inline-flex items-center px-3 rounded-l-md border border-r-0 border-gray-300 bg-gray-50 text-gray-500 sm:text-sm">
                            +62
                        </span>
                        <input type="text" name="phone" placeholder="Nomor Telepon" class="flex-1 min-w-0 block w-full px-4 py-3 rounded-none rounded-r-lg outline-none placeholder-gray-700 bg-[#ffe0cc]" required>
                    </div>

                </div>
                <div class="mb-4">
                    <input type="text" name="email" placeholder="Email" class="w-full px-4 py-3 bg-[#ffe0cc] rounded-lg outline-none placeholder-gray-700" required>
                </div>
                ...
                <div class="mb-4 relative">
                    <input type="password" name="password_confirmation" placeholder="Konfirmasi Password" class="w-full px-4 py-3 bg-[#ffe0cc] rounded-lg outline-none placeholder-gray-700 pr-10" required>
                    <svg class="absolute right-3 top-3.5 w-5 h-5 text-gray-500" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                        <path stroke-linecap="round" stroke-linejoin="round" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.477 0 8.268 2.943 9.542 7-1.274 4.057-5.065 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/>
                    </svg>
            ...
            <p class="text-sm text-center mt-4 text-gray-700">
                already have an account? <a href="<?php echo e(url('/blank-page')); ?>" class="text-blue-600 font-medium">login here</a>
            </p>
        </div>
    </div>
    ...
    <div class="w-1/2 relative flex items-center justify-center overflow-hidden rounded-l-[40px]">
        ...
        <img src="/assets/images/login.png" alt="Login Illustration"
             class="z-10 w-full max-h-[720px] object-contain">
...
<?php /**PATH C:\xampp\htdocs\bakoelide-magang-main\resources\views/signup/signup.blade.php ENDPATH**/ ?>