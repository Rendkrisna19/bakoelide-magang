  ...
  <div class="text-center mt-6">
    <button type="submit" class="bg-[#ffa726] text-white py-3 px-4 rounded-lg font-semibold w-full shadow-lg">
      ...
      <p class="text-sm text-center mt-4 text-gray-700">
        Doesn’t have an account? <a href="<?php echo e(url('/signup')); ?>" class="text-blue-600 font-medium">Create account here</a>
      </p>
    </div>
  </div>
...
<?php /**PATH C:\xampp\htdocs\bakoelide-magang-main\resources\views/blank-page/index.blade.php ENDPATH**/ ?>