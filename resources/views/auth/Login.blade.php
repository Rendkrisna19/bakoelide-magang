...
<body class="min-h-screen flex bg-[#f26522] overflow-hidden">
  <!-- Left Panel -->
  <div class="w-1/2 flex justify-center items-center p-10">
    <div class="w-full max-w-md bg-white bg-opacity-80 p-8 rounded-xl shadow-lg">
      ...
      <form>
        <div class="mb-4">
          <input type="text" placeholder="Email/Number" class="w-full px-4 py-3 bg-[#ffe0cc] rounded-lg outline-none placeholder-gray-700" required />
        </div>
        <div class="mb-4 relative">
          <input type="password" placeholder="Password" class="w-full px-4 py-3 bg-[#ffe0cc] rounded-lg outline-none placeholder-gray-700 pr-10" required />
  ...
  <!-- Right Panel -->
  <div class="w-1/2 relative flex items-center justify-center overflow-hidden rounded-l-[40px] bg-[#f89920]">
    ...
    <!-- Image -->
    <img src="/assets/images/login.png" alt="Login Illustration" class="z-10 w-full max-h-[680px] object-contain" />
